...
{
    class OperationS2 : OperationHao
    {
        protected List<CheckBox> listR = new List<CheckBox>();

        public OperationS2(Dictionary<string, TreeView> dicTreeView, Dictionary<string, ComboBox> dicComboBox, TextBox txtState, TextBox txtSave, Label lblTo, ProgressBar pgb, List<CheckBox> listR, RadioButton rbnSingle) : base(dicTreeView, dicComboBox, txtState, txtSave, lblTo, pgb, rbnSingle)
        {
            this.listR = listR;
        }
            ...
            try
            {
                ...
                Task task = new Task(() =>
                {
                    ...
                    foreach (KeyValuePair<string, string[]> item in dic)
                    {
                        ...
                        {
                            DissimiliratyS2 distance = new DissimiliratyS2(path.Value, savePath, listR, item.Key, Precision);
